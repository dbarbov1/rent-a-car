    ...
    return (
        <React.Fragment>
            ...
            <button type="button" className="btn btn-info" data-toggle="modal" data-target={dataTarget}
                    onClick={(e) => props.getVehicle(e, props.elementId)}>Update
            </button>
                ...
                <div className="modal-dialog" role="document">
                    <div className="modal-content">
                        <div className="modal-header">
                            <span className="modal-title" id="exampleModalLabel">Update Vehicle</span>
                        ...
                        <div className="modal-footer">
                            ...
                            <button type="button"
                                    ...
                                    data-dismiss="modal"
                                    onClick={(event) => props.updateVehicle(event, props.elementId)}>Update
                            </button>
                        </div>
                    </div>
                </div>
